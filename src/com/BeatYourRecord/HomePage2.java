...
public class HomePage2 extends Activity {
 ...
 b.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent i1 = new Intent(HomePage2.this, TournamentPage.class);
 ...
 b1.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			Intent i1 = new Intent(HomePage2.this, HomePage.class);
...
public void onClick(View v) {
	Intent i1 = new Intent(HomePage2.this, VideoDemo1.class);
