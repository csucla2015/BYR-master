...
String filepath="";
  ...
  public void onCreate(Bundle savedInstanceState) {
   ...
   // SharedPreferences pref = getApplicationContext().getSharedPreferences("BYRPref", 0); // 0 - for private mode
    ...
    SharedPreferences pref1 = DetailsActivity.this.getSharedPreferences("TourPref", 0); // 0 - for private mode
    ...
    findViewById(R.id.captureButton1).setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View v) {
          Intent i1 = new Intent(DetailsActivity.this, VideoDemo.class);
        Bundle b = new Bundle();
    ...
    findViewById(R.id.captureButton2).setOnClickListener(new OnClickListener() {
        @Override
        public void onClick(View v) {
      		Intent i1 = new Intent(DetailsActivity.this, Landing.class);
    ...
    findViewById(R.id.captureButton).setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
        Intent i1 = new Intent(DetailsActivity.this, AndroidVideoCapture.class);
      Bundle b = new Bundle();
               ...
               MediaScannerConnectionClient() {
                ...
                public void onScanCompleted(String path, Uri uri) {
                    //This is where you get your content uri
                        Log.d("test", uri.toString());
                        needed = uri;
                     Intent intent = new Intent(DetailsActivity.this, SubmitActivity.class);
                    intent.setData(needed);
...
//Changed by Meet
    ...
    case GALLERY_RETURN:
      if (resultCode == RESULT_OK) {
        ...
        Uri baseUri = Uri.parse(data.getData().getPath());
         Log.d("test2", data.getData().toString());

        Log.v("get data",data.getData().getPath());
